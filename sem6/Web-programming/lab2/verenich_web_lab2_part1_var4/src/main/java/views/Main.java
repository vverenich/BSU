            ...
            switch (answer) {
                ...
                case "2" -> {
                    try 
                    {
                        ...
                        System.out.println("Please, enter faculty's ID:");
                        int id = in.nextInt();
                        ArrayList<Abiturient> abiturients = (ArrayList<Abiturient>) controller.getAbiturientsWithAvgMoreThanAvgOfFaculty(id);
                        if (abiturients.isEmpty())
                        {
                            System.out.println("We're sorry, but there are no any abiturient");
                        }
                ...
                case "4" -> {
                    try 
                    {
                        ...
                        controller.registerNewAbiturient(surname, first_name, middle_name, id);
