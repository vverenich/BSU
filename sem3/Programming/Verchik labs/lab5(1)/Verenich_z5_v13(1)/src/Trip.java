...
public class Trip implements Serializable {
	...
	public String toString() {
		...
		return  AppLocale.getString(AppLocale.driver) + ": "+m_driver.getName()+" " +
	...
	public String toString() {
		...
		String stateOfTrip;
		stateOfTrip = m_state==TripState.STATE_DONE?"COMPLETED":"IN PROGRESS";
		return  "DRIVER: "+m_driver.getName()+"\t| " +
				"CAR: "+m_driver.getCar().getMark()+"\t| "+
				"CAR NUMBER: "+m_driver.getCar().getID() + "\t| "+
				"CAR STATE: "+stateOfCar+"\t| "+
				"ROUTE: "+m_route+"\t\t| "+
				"TRIP STATE: "+stateOfTrip+"| ";
